...
from model.modeling_albert import BertConfig, AlbertForMultipleChoice
...
from processors.multiple_choice import multiple_processors as processors
# from processors import glue_convert_examples_to_features as convert_examples_to_features
from processors.multiple_choice import multiple_convert_examples_to_features as convert_examples_to_features
# from processors import collate_fn
from processors.multiple_choice import collate_fn
...
MODEL_CLASSES = {
    'albert': (BertConfig, AlbertForMultipleChoice, BertTokenizer)
}
...
def load_and_cache_examples(args, task, tokenizer, data_type='train'):
    ...
    all_input_ids = torch.tensor(
        [[choice['input_ids'] for choice in feature.choices_features] for feature in features],
        dtype=torch.long)
    all_attention_mask = torch.tensor(
        [[choice['input_mask'] for choice in feature.choices_features] for feature in features],
        dtype=torch.long)
    all_token_type_ids = torch.tensor(
        [[choice['segment_ids'] for choice in feature.choices_features] for feature in features],
        dtype=torch.long)
